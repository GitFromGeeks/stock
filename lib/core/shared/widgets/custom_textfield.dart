...
class CustomTextField extends StatefulWidget {
  ...
  const CustomTextField({
    ...
    this.errorStyle = const TextStyle(height: 0, color: Colors.transparent),
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextFormField(
            ...
            inputFormatters: [LengthLimitingTextInputFormatter(widget.limit)],
            maxLines:
                (widget.expands)
                    ? null
                    : widget.multiline
